...
public class SettingsScreen extends SpruceScreen {
    ...
    public SettingsScreen(@Nullable Screen parent) {
        super(new TranslatableComponent("lambdynlights.menu.title"));
        this.parent = parent;
        ...
        this.entitiesOption = new SpruceBooleanOption("lambdynlights.option.entities",
                ...
                new TranslatableComponent("lambdynlights.tooltip.entities"), true);
        this.blockEntitiesOption = new SpruceBooleanOption("lambdynlights.option.block_entities",
                ...
                new TranslatableComponent("lambdynlights.tooltip.block_entities"), true);
        this.waterSensitiveOption = new SpruceBooleanOption("lambdynlights.option.water_sensitive",
                ...
                new TranslatableComponent("lambdynlights.tooltip.water_sensitive"), true);
        this.creeperLightingOption = new SpruceCyclingOption("entity.minecraft.creeper",
                ...
                new TranslatableComponent("lambdynlights.tooltip.creeper_lighting",
        ...
        this.tntLightingOption = new SpruceCyclingOption("block.minecraft.tnt",
                ...
                new TranslatableComponent("lambdynlights.tooltip.tnt_lighting",
                        ExplosiveLightingMode.OFF.getTranslatedText(),
                        ExplosiveLightingMode.SIMPLE.getTranslatedText(),
                        ExplosiveLightingMode.FANCY.getTranslatedText()));
    ...
    protected void init() {
        ...
        this.addChild(new SpruceButtonWidget(Position.of(this, this.width / 2 - 155 + 160, this.height - 29), 150, 20, new TranslatableComponent("gui.done"),
    ...
    public void renderTitle(PoseStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (LambDynLightsCompat.isCanvasInstalled()) {
            drawCenteredString(matrices, this.textRenderer, I18n.get("lambdynlights.menu.canvas.1"), this.width / 2, this.height - 29 - (5 + this.textRenderer.fontHeight) * 3, 0xFFFF0000);
            drawCenteredString(matrices, this.textRenderer, I18n.get("lambdynlights.menu.canvas.2"), this.width / 2, this.height - 29 - (5 + this.textRenderer.fontHeight) * 2, 0xFFFF0000);
        }
    }
}

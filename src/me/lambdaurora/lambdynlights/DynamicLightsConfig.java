...
public class DynamicLightsConfig {
    ...
    public final SpruceOption dynamicLightsModeOption = new SpruceCyclingOption("lambdynlights.option.mode",
            ...
            new TranslatableComponent("lambdynlights.tooltip.mode.1")
                    .append(new TextComponent("\n"))
                    .append(new TranslatableComponent("lambdynlights.tooltip.mode.2", DynamicLightsMode.FASTEST.getTranslatedText(), DynamicLightsMode.FAST.getTranslatedText()))
                    .append(new TextComponent("\n"))
                    .append(new TranslatableComponent("lambdynlights.tooltip.mode.3", DynamicLightsMode.FANCY.getTranslatedText())));
